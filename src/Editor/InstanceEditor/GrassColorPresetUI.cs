...
{
    public class GrassColorPresetUI : KKWindow
    {
        ...
        private static GrassColorPresetUI _instance = null;
        ...
        internal static GrassColorPresetUI instance
        {
            get
            {
                if (_instance == null)
                {
                    _instance = new GrassColorPresetUI();
