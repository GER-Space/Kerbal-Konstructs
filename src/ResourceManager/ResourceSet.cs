...
namespace KerbalKonstructs.ResourceManager {
	...
	public class RMResourceSet {
		...
		public static double UnbalancedTransfer (RMResourceInfo resourceInfo, double amount)
		{
		...
		public static double BalancedTransfer (RMResourceInfo resourceInfo, double amount)
		{
			double setTotal = 0;
			if (amount < 0) {
